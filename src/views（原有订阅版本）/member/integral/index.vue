<template>
  <div class="main">
      ...
      <ul>
        <li>
          <div class="left">
            ...
            <div class="text">
              <p class="title">首次綁定合同號</p>
              <p class="award">獎勵100積分</p>
            </div>
          </div>
    ...
    <el-dialog
      ...
      <p style="margin-top: 15px;font-size: 12px;">分享此鏈接給好友，註冊成功即可領取積分</p>
      <span slot="footer" class="dialog-footer">
        <el-button size="mini" @click="copyUrlShow = false">取消</el-button>
        <el-button size="mini" type="primary" v-clipboard:copy="url" v-clipboard:success="onSuccess" v-clipboard:error="onError">複製</el-button>
      </span>
    </el-dialog>

    <div class="mask" v-if="maskShow" @click="maskShow=false"><p>齊齊有福利，你想起了誰？<i class="el-icon-top"></i></p></div>
        ...
        if(res.code == 200){
          ...
          wx.ready(function () {   //需在用户可能点击分享按钮前就先调用
              wx.updateAppMessageShareData({
                  title: JSON.parse(sessionStorage.userInfo).userName + '邀請您使用澳門自來水微信服務。', // 分享标题
                  desc: '查詢、繳費、申請服務。', // 分享描述
