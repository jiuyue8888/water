<template>
  <div class="main">
    ...
    <div class="body">
      <!-- 标题 -->
      <div class="title">澳門自來水承諾遵守第8/2005號法律《個人資料保護法》的有關規定。因此,我們十分重視對網頁使用者私隱的保護,相關會員信息將經過加密處理,我们建議您先細閱《<span @click="lockStatement">收集個人資料聲明</span>》《<span @click="electronicShow=true">電子服務及免責條款</span>》</div>

      <!-- 填写邮箱 -->
      <el-form ref="form" :rules="rules" :model="form" label-width="82px">
        <el-form-item label="郵箱地址：" prop="email">
          <el-input class="underline" v-model="form.email" placeholder="請輸入新的郵箱地址"></el-input>
        </el-form-item>
        <el-form-item label="密碼：" prop="pass">
          <el-input class="underline" type="password" v-model="form.pass" placeholder="請輸入密碼"></el-input>
        </el-form-item>
      </el-form>

      <!-- 忘记密码 -->
      <el-button type="text" class="forget-pass" @click="forgetPass">忘記密碼？</el-button>
