<template>
  <div class="main">
    ...
    <div class="info">
      ...
      <Header metaTitle="主頁" />
      <div class="content">
        <div class="integral">{{ integralNum }}<p>積分</p></div>
        <div class="gift" @click="openMygift">{{ giftNum }}<p>禮品</p></div>
      </div>
      <router-link to="/member/gift/record">
        <div class="detail">積分詳情<i class="el-icon-arrow-right"></i></div>
      </router-link>
    </div>
    <!-- 消息 -->
    <div class="message">
...
<!--        <li v-for="item in giftList">-->
          ...
          <el-button @click="exchange(item)" class="deep-blue" size="mini" round>{{ item.giftPrice }} 積分兌換</el-button>
        </li>
      </ul>
    </div>
    ...
    <el-dialog
      ...
      <div class="title">
        ...
        <div style="padding-left: 13px">
          ...
          <p style="padding-top: 20px"><span>{{ form.giftPrice }}</span> 積分</p>
        </div>
      </div>
...
<!--        </div>-->
      ...
      <span slot="footer" class="dialog-footer">
        <el-button round @click="exchangeShow = false">取消</el-button>
        <el-button round type="primary" @click="exchangeConfirm">積分兌換</el-button>
      </span>
    </el-dialog>
